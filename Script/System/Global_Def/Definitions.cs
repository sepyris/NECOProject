...
namespace Definitions
{
    ...
    public static class Def_Name
    {
        ...
        public const string SCENE_NAME_DEFAULT_MAP = "Map_Town_MainVillage";
    ...
    public static class Def_Values
    {
        ...
        public const UnityEngine.KeyCode DEBUG_FORCE_STOP_KEY = UnityEngine.KeyCode.F1;
    ...
    public static class Def_Layer_Mask_Values
    {
        ...
        public const int LAYER_MASK_PORTAL_OBJECT = 1 << 12;     // BlockingObject
    ...
    {
        // 키 입력
        public const KeyCode OPEN_QUEST_UI_KEY = KeyCode.Q;
    ...
    public static class SceneHelpers
    {
        ...
        {
            return !string.IsNullOrEmpty(sceneName) && sceneName.StartsWith(Def_Name.SCENE_NAME_START_MAP);
        }
